...
output_dir = "/netscratch/jperez/mistral_en_text_sparql"
...
process_jsonl_file("/netscratch/jperez/training_dataset.jsonl")


train_dataset = load_dataset(
    "json", data_files="/netscratch/jperez/training_dataset.jsonl", split="train"
)


eval_prompt = "Write a SparQL query that answers this request: 'Was Google founded by Bill Gates?' from the knowledge graph Wikidata."
messages = [
    {
        "role": "user",
        "content": "Write a SparQL query that answers this question/request: 'Was Google founded by Bill Gates?' from the knowledge graph Wikidata.",
    }
]
...
messages = [
    {
        "role": "user",
        "content": "Write a SparQL query that answers this request: 'Was Google founded by Bill Gates?' from the knowledge graph Wikidata.",
    },
]
