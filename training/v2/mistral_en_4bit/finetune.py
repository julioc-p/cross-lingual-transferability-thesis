...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataArguments, LoraArguments, SFTConfig))
    (
        model_args,
        data_args,
        lora_args,
    ...
    sft_config = get_sft_config(sft_config.output_dir, data_args.max_seq_length)

    # Load model and tokenizer
    model, tokenizer = load_model_and_tokenizer(
        model_args.model_name_or_path, bnb_config, data_args.max_seq_length
    )
