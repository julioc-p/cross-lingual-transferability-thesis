...
\newcommand{\declarationofintegrity}[1]{%
	...
	{\parindent0cm
		\subsection*{Declaration of academic integrity}
            I hereby declare that all written work stems from original ideas, and all of which originates from external sources, is correctly referenced and/or cited.
