...
By comparing the Occiglot-7b-eu5 model, a result of continual pre-training of Mistral 7B v0.1 on five European languages \cite{avramidis-etal-2024-occiglot}, against the original Mistral model, this work sought to elucidate the nuanced effects of such pre-training strategies.
...
\begin{itemize}
    ...
    While Occiglot maintained comparable or sometimes superior executable query generation rates in English, Mistral significantly outperformed it in F1-score on the complex QALD-10 benchmark when both were provided with English contextual mappings (v2) and also on the v1 test set. 
    ...
    \item The nature of the test dataset significantly influences observed performance. 
