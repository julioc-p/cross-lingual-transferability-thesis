...
\begin{itemize}
    ...
    While Occiglot maintained comparable or sometimes superior executable query generation rates in English, Mistral significantly outperformed it in F1-score on the complex QALD-10 English benchmark under both fine-tuning conditions (v1 and v2).
